!function() {
    ...
    u.prototype.append = function(e) {
        "number" == typeof e ? this._pieces.push(e) : (this.flush(),
        this._parts.push(e))
    }
    ,
    ...
    h.prototype.unpack_string = function(e) {
        for (var t, r, n = this.read(e), i = 0, o = ""; i < e; )
            (t = n[i]) < 128 ? (o += String.fromCharCode(t),
            i++) : (192 ^ t) < 32 ? (r = (192 ^ t) << 6 | 63 & n[i + 1],
            o += String.fromCharCode(r),
            i += 2) : (r = (15 & t) << 12 | (63 & n[i + 1]) << 6 | 63 & n[i + 2],
            o += String.fromCharCode(r),
            i += 3);
        return this.index += e,
        o
    ...
    m.prototype.pack = function(e) {
        ...
        if ("string" === t)
            ...
            if (null === e)
                ...
                if (r == Array)
                    this.pack_array(e);
                else if (r == Blob || r == File || e instanceof Blob || e instanceof File)
                    this.pack_bin(e);
                else if (r == ArrayBuffer)
                    f.useArrayBufferView ? this.pack_bin(new Uint8Array(e)) : this.pack_bin(e);
                else if ("BYTES_PER_ELEMENT"in e)
                    f.useArrayBufferView ? this.pack_bin(new Uint8Array(e.buffer)) : this.pack_bin(e.buffer);
    ...
    function _(e) {
        return "boolean" != typeof e ? new Error("Argument type: " + (void 0 === e ? "undefined" : c(e)) + ". Please use a boolean.") : (y = e,
        e ? "adapter.js logging disabled" : "adapter.js logging enabled")
    }
    function S(e) {
        return "boolean" != typeof e ? new Error("Argument type: " + (void 0 === e ? "undefined" : c(e)) + ". Please use a boolean.") : (g = !e,
                ...
                return Object.keys(e).forEach((function(r) {
                    if ("require" !== r && "advanced" !== r && "mediaSource" !== r) {
                        ...
                        if (void 0 !== n.ideal) {
                            ...
                            var o = {};
                            "number" == typeof n.ideal ? (o[i("min", r)] = n.ideal,
                            t.optional.push(o),
                            (o = {})[i("max", r)] = n.ideal,
                            t.optional.push(o)) : (o[i("", r)] = n.ideal,
                            t.optional.push(o))
                        }
              ...
              , i = function(e, i) {
                ...
                if (e && "object" == typeof e.video) {
                    ...
                    if (a && ("user" === a.exact || "environment" === a.exact || "user" === a.ideal || "environment" === a.ideal) && (!r.mediaDevices.getSupportedConstraints || !r.mediaDevices.getSupportedConstraints().facingMode || c))
                        ...
                        "environment" === a.exact || "environment" === a.ideal ? s = ["back", "rear"] : "user" !== a.exact && "user" !== a.ideal || (s = ["front"]),
                        s)
                            return r.mediaDevices.enumerateDevices().then((function(t) {
                                ...
                                return !r && t.length && s.includes("back") && (r = t[t.length - 1]),
                                r && (e.video.deviceId = a.exact ? {
                                    exact: r.deviceId
                                } : {
                                    ideal: r.deviceId
                                }),
    ...
    function U(e, t) {
        ...
        if (e.RTCPeerConnection) {
            ...
            e.RTCPeerConnection.prototype.setLocalDescription = function() {
                return arguments.length && arguments[0].type ? (arguments[0] = n(this, arguments[0]),
    ...
    function K(e, t, r, n, i) {
        ...
        if (o += W.writeIceParameters(e.iceGatherer.getLocalParameters()),
        ...
        return e.codecs.forEach((function(n) {
            for (var o = 0; o < t.codecs.length; o++) {
                ...
                if (n.name.toLowerCase() === a.name.toLowerCase() && n.clockRate === a.clockRate) {
                    if ("rtx" === n.name.toLowerCase() && n.parameters && a.parameters.apt && !i(n, a, e.codecs, t.codecs))
                        continue;
    ...
    function ee(t, r) {
        ...
        t.RTCPeerConnection = function(e) {
            var t, n;
            return e && e.iceServers && (e.iceServers = (t = e.iceServers,
            r.version,
            n = !1,
    ...
    H.parseRtpParameters = function(e) {
        for (var t = {
            ...
            if (o) {
                ...
                switch (a.parameters = s.length ? H.parseFmtp(s[0]) : {},
    ...
    H.parseRtpEncodingParameters = function(e) {
        var t, r = [], n = H.parseRtpParameters(e), i = -1 !== n.fecMechanisms.indexOf("RED"), o = -1 !== n.fecMechanisms.indexOf("ULPFEC"), a = H.matchPrefix(e, "a=ssrc:").map((function(e) {
            return H.parseSsrcMedia(e)
        }
        )).filter((function(e) {
            return "cname" === e.attribute
        }
        )), s = a.length > 0 && a[0].ssrc, c = H.matchPrefix(e, "a=ssrc-group:FID").map((function(e) {
        ...
        n.codecs.forEach((function(e) {
            if ("RTX" === e.name.toUpperCase() && e.parameters.apt) {
                ...
                r.push(n),
                i && ((n = JSON.parse(JSON.stringify(n))).fec = {
                    ssrc: s,
        ...
        return p.length && (p = 0 === p[0].indexOf("b=TIAS:") ? parseInt(p[0].substr(7), 10) : 0 === p[0].indexOf("b=AS:") ? 950 * parseInt(p[0].substr(5), 10) - 16e3 : void 0,
    ...
    H.parseSctpDescription = function(e) {
        var t, r = H.parseMLine(e), n = H.matchPrefix(e, "a=max-message-size:");
    ...
    H.writeMediaSection = function(e, t, r, n) {
        ...
        if (i += H.writeIceParameters(e.iceGatherer.getLocalParameters()),
    ...
    J = function(e, t) {
                ...
                return (e = JSON.parse(JSON.stringify(e))).filter((function(e) {
                    if (e && (e.urls || e.url)) {
                        ...
                        n = n.filter((function(e) {
                            return 0 !== e.indexOf("turn:") || -1 === e.indexOf("transport=udp") || -1 !== e.indexOf("turn:[") || r ? 0 === e.indexOf("stun:") && t >= 14393 && -1 === e.indexOf("?transport=udp") : (r = !0,
                            !0)
                        }
                        )),
                        delete e.url,
        ...
        i.prototype.addTrack = function(t, r) {
            if (this._isClosed)
                throw X("InvalidStateError", "Attempted to call addTrack on a closed peerconnection.");
            var n;
        ...
        i.prototype.removeTrack = function(t) {
            if (this._isClosed)
                throw X("InvalidStateError", "Attempted to call removeTrack on a closed peerconnection.");
            ...
            if (!r)
                throw X("InvalidAccessError", "Sender was not created by this connection.");
            var n = r.stream;
            r.rtpSender.stop(),
            r.rtpSender = null,
            r.track = null,
            ...
            if (!i.onlocalcandidate) {
                ...
                i.onlocalcandidate = function(e) {
                    if (!(n.usingBundle && r > 0)) {
                        ...
                        "gathering" !== n.iceGatheringState && (n.iceGatheringState = "gathering",
                        n._emitGatheringStateChange()),
                        s || n._dispatchEvent("icecandidate", o),
                        d && (n._dispatchEvent("icecandidate", new Event("icecandidate")),
        ...
        i.prototype._transceive = function(e, r, n) {
            ...
            r && e.rtpSender && (i.encodings = e.sendEncodingParameters,
            i.rtcp = {
                cname: W.localCName,
            ...
            e.rtpSender.send(i)),
            n && e.rtpReceiver && i.codecs.length > 0 && ("video" === e.kind && e.recvEncodingParameters && t < 15019 && e.recvEncodingParameters.forEach((function(e) {
                delete e.rtx
            }
            )),
        ...
        i.prototype.setLocalDescription = function(e) {
            ...
            if (-1 === ["offer", "answer"].indexOf(e.type))
                return Promise.reject(X("TypeError", 'Unsupported type "' + e.type + '"'));
            ...
            if ("offer" === e.type)
                ...
                t = W.splitSections(n._remoteDescription.sdp),
                r = t.shift();
                ...
                t.forEach((function(e, t) {
                    ...
                    if (!(W.isRejected(e) && 0 === W.matchPrefix(e, "a=bundle-only").length) && !o.rejected) {
                        ...
                        i && (l.role = "server"),
                        n.usingBundle && 0 !== t || (n._gather(o.mid, t),
                        "new" === s.state && s.start(a, u, i ? "controlling" : "controlled"),
        ...
        i.prototype.setRemoteDescription = function(i) {
            ...
            if (-1 === ["offer", "answer"].indexOf(i.type))
                return Promise.reject(X("TypeError", 'Unsupported type "' + i.type + '"'));
            ...
            return o.canTrickleIceCandidates = !!l && l.substr(14).split(" ").indexOf("trickle") >= 0,
            c.forEach((function(n, c) {
                ...
                if (h || "application" === f && ("DTLS/SCTP" === m || "UDP/DTLS/SCTP" === m))
                    ...
                    if (("offer" === i.type || "answer" === i.type) && !h && u && c > 0 && o.transceivers[c] && (o._disposeIceAndDtlsTransports(c),
                    ...
                    "offer" !== i.type || h) {
                        if ("answer" === i.type && !h) {
                            ...
                            M.length && "new" === _.state && (!d && !I || u && 0 !== c ? M.forEach((function(e) {
                                Q(b.iceTransport, e)
                            }
                            )) : _.setRemoteCandidates(M)),
                            u && 0 !== c || ("new" === _.state && _.start(C, E, "controlling"),
                            ...
                            !T || "sendrecv" !== v && "sendonly" !== v ? delete b.rtpReceiver : (R = T.track,
                            y ? (a[y.stream] || (a[y.stream] = new e.MediaStream),
                            r(R, a[y.stream]),
                            s.push([R, T, a[y.stream]])) : (a.default || (a.default = new e.MediaStream),
                            r(R, a.default),
                        ...
                        M.length && "new" === b.iceTransport.state && (!I || u && 0 !== c ? M.forEach((function(e) {
                            Q(b.iceTransport, e)
                        }
                        ...
                        if ("sendrecv" === v || "sendonly" === v) {
                            if (A = !b.rtpReceiver,
                            T = b.rtpReceiver || new e.RTCRtpReceiver(b.dtlsTransport,f),
                            A)
                                R = T.track,
                                y && "-" === y.stream || (y ? (a[y.stream] || (a[y.stream] = new e.MediaStream,
                                ...
                                j = a[y.stream]) : (a.default || (a.default = new e.MediaStream),
                                j = a.default)),
                                j && (r(R, j),
                                b.associatedRemoteMediaStreams.push(j)),
                                s.push([R, T, j])
                        } else
        ...
        i.prototype.createOffer = function() {
            var r = this;
            if (r._isClosed)
                return Promise.reject(X("InvalidStateError", "Can not call createOffer after close"));
            ...
            for (r.transceivers.forEach((function(e) {
                ...
                n > 0 && (r._createTransceiver("audio"),
                n--),
                i > 0 && (r._createTransceiver("video"),
                i--);
            ...
            r.transceivers.forEach((function(n, i) {
                ...
                c.codecs.forEach((function(e) {
                    ...
                    n.remoteCapabilities && n.remoteCapabilities.codecs && n.remoteCapabilities.codecs.forEach((function(t) {
        ...
        i.prototype.createAnswer = function() {
            var r = this;
            if (r._isClosed)
                return Promise.reject(X("InvalidStateError", "Can not call createAnswer after close"));
            ...
            r.transceivers.forEach((function(e, o) {
                if (!(o + 1 > i)) {
                    if (e.rejected)
                        return "application" === e.kind ? "DTLS/SCTP" === e.protocol ? n += "m=application 0 DTLS/SCTP 5000\r\n" : n += "m=application 0 " + e.protocol + " webrtc-datachannel\r\n" : "audio" === e.kind ? n += "m=audio 0 UDP/TLS/RTP/SAVPF 0\r\na=rtpmap:0 PCMU/8000\r\n" : "video" === e.kind && (n += "m=video 0 UDP/TLS/RTP/SAVPF 120\r\na=rtpmap:120 VP8/90000\r\n"),
        ...
        i.prototype.addIceCandidate = function(e) {
            ...
            return e && void 0 === e.sdpMLineIndex && !e.sdpMid ? Promise.reject(new TypeError("sdpMLineIndex or sdpMid required")) : new Promise((function(n, i) {
                if (!r._remoteDescription)
                    return i(X("InvalidStateError", "Can not add ICE candidate without a remote description"));
                if (e && "" !== e.candidate) {
                    ...
                    for (var d = 0; d < r.transceivers.length && (r.transceivers[d].rejected || (r.transceivers[d].iceTransport.addRemoteCandidate({}),
                    (t = W.getMediaSections(r._remoteDescription.sdp))[d] += "a=end-of-candidates\r\n",
                    r._remoteDescription.sdp = W.getDescription(r._remoteDescription.sdp) + t.join(""),
                    !r.usingBundle)); d++)
                        ;
                n()
            ...
            e.RTCPeerConnection = function(e, r) {
                if (e && e.iceServers) {
                    for (var n = [], i = 0; i < e.iceServers.length; i++) {
                        ...
                        !o.hasOwnProperty("urls") && o.hasOwnProperty("url") ? (k("RTCIceServer.url", "RTCIceServer.urls"),
                        (o = JSON.parse(JSON.stringify(o))).urls = o.url,
                        delete o.url,
                        n.push(o)) : n.push(e.iceServers[i])
                    }
                    e.iceServers = n
                }
                return new t(e,r)
    ...
    function Pe(t) {
        if (!(!t.RTCIceCandidate || t.RTCIceCandidate && "foundation"in t.RTCIceCandidate.prototype)) {
            ...
            t.RTCIceCandidate = function(t) {
                if ("object" == typeof t && t.candidate && 0 === t.candidate.indexOf("a=") && ((t = JSON.parse(JSON.stringify(t))).candidate = t.candidate.substr(2)),
    ...
    function Re(t, r) {
        if (t.RTCPeerConnection) {
            ...
            var n = function(t) {
              ...
              , o = function(e) {
                var t = 65536;
                return "firefox" === r.browser && (t = r.version < 57 ? -1 === e ? 16384 : 2147483637 : r.version < 60 ? 57 === r.version ? 65535 : 65536 : 2147483637),
                t
            }
              , a = function(t, n) {
                var i = 65536;
            ...
            t.RTCPeerConnection.prototype.setRemoteDescription = function() {
                ...
                if (n(arguments[0])) {
                    var t, c = i(arguments[0]), p = o(c), d = a(arguments[0], c);
    ...
    }), Ae = je, Le = Ae.default || Ae, Be = new ((Ie = function() {
    ...
    Ie.prototype.isUnifiedPlanSupported = function() {
        var e, t = this.getBrowser(), r = Le.browserDetails.version || 0;
        if ("chrome" === t && r < this.minChromeVersion)
            return !1;
        if ("firefox" === t && r >= this.minFirefoxVersion)
            return !0;
    ...
    var ze, Ge = Object.prototype.hasOwnProperty, Ve = "~";
    function Je() {}
    function We(e, t, r) {
        this.fn = e,
        this.context = t,
    ...
    function He(e, t, r, n, i) {
        ...
        var o = new We(r,n || e,i)
          , a = Ve ? Ve + t : t;
        return e._events[a] ? e._events[a].fn ? e._events[a] = [e._events[a], o] : e._events[a].push(o) : (e._events[a] = o,
        e._eventsCount++),
        e
    }
    function Ke(e, t) {
    ...
    Object.create && (Je.prototype = Object.create(null),
    (new Je).__proto__ || (Ve = !1)),
    ...
    Ye.prototype.emit = function(e, t, r, n, i, o) {
        ...
        if (!this._events[a])
            return !1;
        var s, c, p = this._events[a], d = arguments.length;
        if (p.fn) {
            ...
            case 2:
                ...
                !0;
            case 3:
                return p.fn.call(p.context, t, r),
                !0;
            case 4:
                return p.fn.call(p.context, t, r, n),
                !0;
            case 5:
                return p.fn.call(p.context, t, r, n, i),
                !0;
            case 6:
                return p.fn.call(p.context, t, r, n, i, o),
                !0
            }
            for (c = 1,
    ...
    Ye.prototype.removeListener = function(e, t, r, n) {
        ...
        if (o.fn)
            ...
            for (var a = 0, s = [], c = o.length; a < c; a++)
                (o[a].fn !== t || n && !o[a].once || r && o[a].context !== r) && s.push(o[a]);
    ...
    Ye.prototype.removeAllListeners = function(e) {
        var t;
        return e ? (t = Ve ? Ve + e : e,
        this._events[t] && Ke(this, t)) : (this._events = new Je,
        this._eventsCount = 0),
        this
    }
    ,
    ...
    et.prototype._print = function(e) {
        ...
        var n = Ze([$e], Xe(t), !1);
        for (var i in n)
            n[i]instanceof Error && (n[i] = "(" + n[i].name + ") " + n[i].message);
    ...
    function(e, t) {
        ...
        var t = function(t, r, n, i, o, a) {
            ...
            s._messagesQueue = [];
            var c = t ? "wss://" : "ws://";
            return s._baseUrl = c + r + ":" + n + i + "peerjs?key=" + o,
            s
        };
        return ut(t, e),
        t.prototype.start = function(e, t) {
            ...
            !this._socket && this._disconnected && (this._socket = new WebSocket(n + "&version=" + pt.version),
            ...
            this._socket.onclose = function(e) {
                r._disconnected || (qe.default.log("Socket closed.", e),
                r._cleanup(),
                r._disconnected = !0,
            ...
            this._socket.onopen = function() {
                r._disconnected || (r._sendQueuedMessages(),
        ...
        t.prototype._sendHeartbeat = function() {
            if (this._wsOpen()) {
                ...
                qe.default.log("Cannot send heartbeat, because socket closed")
        }
        ,
            ...
            if (!this._disconnected)
                if (this._id)
                    if (e.type) {
                        ...
                        this.emit(it.Error, "Invalid message");
                else
      ...
      , _t = function() {
        ...
        e.prototype._setupListeners = function(e) {
            ...
            e.onicecandidate = function(e) {
                e.candidate && e.candidate.candidate && (qe.default.log("Received ICE candidates for ".concat(r, ":"), e.candidate),
                o.socket.send({
                    type: ot.Candidate,
                    payload: {
            ...
            return bt(this, void 0, Promise, (function() {
                ...
                return Ct(this, (function(s) {
                    ...
                    case 4:
                        ...
                        this.connection.type === tt.Data && (i = this.connection,
                        n = gt(gt({}, n), {
                            label: i.label,
                            reliable: i.reliable,
                        ...
                        [3, 6];
                    case 5:
                        return "OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer" != (o = s.sent()) && (t.emitError(rt.WebRTC, o),
            ...
            return bt(this, void 0, Promise, (function() {
                ...
                return Ct(this, (function(s) {
                    ...
                    case 1:
                        ...
                        [4, i.addIceCandidate(new RTCIceCandidate({
                            sdpMid: n,
                            sdpMLineIndex: r,
                            candidate: t
                        }))];
                    case 2:
                        return s.sent(),
                        qe.default.log("Added ICE candidate for:".concat(this.connection.peer)),
                        [3, 4];
                    case 3:
                        return a = s.sent(),
        ...
        e.prototype._addTracksToConnection = function(e, t) {
            if (qe.default.log("add tracks from stream ".concat(e.id, " to peer connection")),
            !t.addTrack)
        ...
        e.prototype._addStreamToMediaConnection = function(e, t) {
            qe.default.log("add stream ".concat(e.id, " to media connection ").concat(t.connectionId)),
            t.addStream(e)
        }
        ,
        e
    ...
    var Tt = function() {
      ...
      , Et = function(e) {
        ...
        t.prototype.handleMessage = function(e) {
            ...
            switch (e.type) {
            case ot.Answer:
                this._negotiator.handleSDP(t, r.sdp),
                this._open = !0;
                break;
            case ot.Candidate:
        ...
        t.prototype.answer = function(e, t) {
            ...
            this._localStream)
                ...
                this._negotiator.startConnection(Pt(Pt({}, this.options._payload), {
                    _stream: e
                }));
        ...
        t.prototype.close = function() {
            ...
            e.prototype.emit.call(this, "close"))
        }
        ,
        t.ID_PREFIX = "mc_",
        t
    ...
    var Ot = function() {
      ...
      , It = function(e) {
        var t = function() {
            ...
            return t.fileReader = new FileReader,
            t._queue = [],
            t._processing = !1,
        ...
        t.prototype.doNextTask = function() {
            0 !== this.size && (this.processing || (this._processing = !0,
      ...
      , At = function(e) {
        function t(r, n, i) {
            var o = e.call(this, r, n, i) || this;
            return o.stringify = JSON.stringify,
            o.parse = JSON.parse,
            o._buffer = [],
            o._bufferSize = 0,
            o._buffering = !1,
            ...
            o._encodingQueue.on("error", (function() {
                qe.default.error("DC#".concat(o.connectionId, ": Error occured in encoding from blob to arraybuffer, close DC")),
                o.close()
            }
            )),
            o._negotiator = new yt.Negotiator(o),
            o._negotiator.startConnection(o.options._payload || {
                originator: !0
            }),
            o
        }
        ...
        t.prototype._configureDataChannel = function() {
            ...
            this.dataChannel.onopen = function() {
                qe.default.log("DC#".concat(e.connectionId, " dc connection success")),
                e._open = !0,
                e.emit("open")
            }
            ,
            this.dataChannel.onmessage = function(t) {
                qe.default.log("DC#".concat(e.connectionId, " dc onmessage:"), t.data),
                e._handleDataMessage(t)
            }
            ,
            this.dataChannel.onclose = function() {
                qe.default.log("DC#".concat(e.connectionId, " dc closed for:"), e.peer),
                e.close()
            }
        }
        ,
        t.prototype._handleDataMessage = function(t) {
            ...
            if (this.serialization === nt.Binary || this.serialization === nt.BinaryUTF8) {
                ...
                this.serialization === nt.JSON && (o = this.parse(n));
        ...
        t.prototype.close = function() {
            ...
            this._dc = null),
            this._encodingQueue && (this._encodingQueue.destroy(),
        ...
        t.prototype.send = function(t, r) {
            if (this.open)
                if (this.serialization === nt.JSON)
                    ...
                    var n = Fe.pack(t);
                    if (!r && n.size > Fe.chunkedMTU)
                        return void this._sendChunks(n);
                    Fe.supports.binaryBlob ? this._bufferedSend(n) : this._encodingQueue.enque(n)
                } else
                    this._bufferedSend(t);
            else
                e.prototype.emit.call(this, "error", new Error("Connection is not open. You should listen for the `open` event before sending messages."))
        }
        ,
        ...
        t.prototype._trySend = function(e) {
            ...
            try {
                ...
                return qe.default.error("DC#:".concat(this.connectionId, " Error when sending:"), e),
                this._buffering = !0,
                this.close(),
                !1
            }
    ...
    var Bt = function(e, t, r, n) {
      ...
      , Ft = function() {
        ...
        return e.prototype._buildRequest = function(e) {
            ...
            return s.searchParams.set("ts", "".concat(Date.now()).concat(Math.random())),
            ...
            return Bt(this, void 0, Promise, (function() {
                ...
                return Nt(this, (function(n) {
                    ...
                    case 2:
                        ...
                        r = "",
                        "/" === this._options.path && this._options.host !== Fe.CLOUD_HOST && (r = " If you passed in a `path` to your self-hosted PeerServer, you'll also need to pass in that same path when creating a new Peer."),
        ...
        e.prototype.listAllPeers = function() {
            return Bt(this, void 0, Promise, (function() {
                ...
                return Nt(this, (function(n) {
                    ...
                    case 0:
                        return n.trys.push([0, 2, , 3]),
                        [4, this._buildRequest("peers")];
                    case 1:
                        if (200 !== (e = n.sent()).status) {
                            if (401 === e.status)
                                throw t = "",
                                t = this._options.host === Fe.CLOUD_HOST ? "It looks like you're using the cloud server. You can email team@peerjs.com to enable peer listing for your API key." : "You need to enable `allow_discovery` on your self-hosted PeerServer to use this feature.",
      ...
      , Jt = function(e) {
        function t(r, n) {
            ...
            o._options.path && ("/" !== o._options.path[0] && (o._options.path = "/" + o._options.path),
            ...
            Fe.supports.audioVideo || Fe.supports.data ? i && !Fe.validateId(i) ? (o._delayedAbort(rt.InvalidID, 'ID "'.concat(i, '" is invalid')),
            o) : (i ? o._initialize(i) : o._api.retrieveId().then((function(e) {
            ...
            o) : (o._delayedAbort(rt.BrowserIncompatible, "The current browser does not support WebRTC"),
            o)
        }
        return Ut(t, e),
        ...
        t.prototype._createServerConnection = function() {
            ...
            t.on(it.Disconnected, (function() {
                e.disconnected || (e.emitError(rt.Network, "Lost connection to server."),
                e.disconnect())
            }
            )),
        ...
        t.prototype._handleMessage = function(e) {
            var t, r, n = e.type, i = e.payload, o = e.src;
            switch (n) {
            case ot.Open:
            ...
            case ot.Offer:
                ...
                if ((f = this.getConnection(o, a)) && (f.close(),
                qe.default.warn("Offer received for existing Connection ID:".concat(a))),
                i.type === tt.Media) {
                    ...
                    f = s,
                    this._addConnection(o, f),
                    this.emit("call", s)
                } else {
                    if (i.type !== tt.Data)
                        return void qe.default.warn("Received malformed connection type:".concat(i.type));
            ...
            default:
                if (!i)
                    return void qe.default.warn("You received a malformed message from ".concat(o, " of type ").concat(n));
                var f;
                a = i.connectionId;
        ...
        t.prototype.connect = function(e, t) {
            if (void 0 === t && (t = {}),
            this.disconnected)
                return qe.default.warn("You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect, or call reconnect on this peer if you believe its ID to still be available."),
        ...
        t.prototype.call = function(e, t, r) {
            if (void 0 === r && (r = {}),
            this.disconnected)
                return qe.default.warn("You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect."),
                void this.emitError(rt.Disconnected, "Cannot connect to new Peer after disconnecting from server.");
            if (t) {
        ...
        ,
        t.prototype.destroy = function() {
            this.destroyed || (qe.default.log("Destroy peer with ID:".concat(this.id)),
            this.disconnect(),
            this._cleanup(),
            this._destroyed = !0,
            this.emit("close"))
